...
(unreleased)
------------
- Chore: Merged development into master (#42) [Daniel Howard, Daniel
  ...
  * Test    This should not work    * fix: This should work    * feat:
  ...
  rmcclelen2 <54422682+rmcclelen2@users.noreply.github.com>, DannyBoy4u,
  DannyBoy4u, DannyBoy4u, DannyBoy4u, Reece Bourgeois, Robert Herbert,
  Robert Herbert, Robert Herbert, Robert Herbert, Robert Herbert
  <r.herbert@live.com>    * ._. (#19)    * added github pages extension
  (#20)    * Dev to main (#21)    * Added poetry    * added names    *
  ...
  * changed python requirement    * made note to devs    * moved save
  ...
  <robert.herbert@selu.edu>, Robert Herbert, Robert Herbert, Robert
  Herbert, Robert Herbert, Robert Herbert, Robert Herbert
  ...
  * moved save and xml wizardry    * removed unused import    * updated
  ...
  Herbert <robert.herbert@selu.edu>, Ryan McClelen, Ryan McClelen, Ryan
  McClelen, Ryan McClelen, Ryan McClelen, Ryan McClelen
  ...
  * changed python requirement    * made note to devs    * moved save
  and xml wizardry    * removed unused import    * updated for save
  function    * removed local code    * Added action    * small update
  Co-authored-by: Robert Herbert <robert.herbert@selu.edu>]
